const housingData = {
  ...
  capacity: 10,
  residents: [
    { name: 'Prabodhan Fitzgerald', phone: '345679', avatar: '/path-to-avatar-1.jpg' },
    { name: 'Hiro Joyce', phone: '345679', avatar: '/path-to-avatar-2.jpg' },
    { name: 'Lloyd Jefferson', phone: '345679', avatar: '/path-to-avatar-3.jpg' },
    { name: 'Ceiran Mayo', phone: '345679', avatar: '/path-to-avatar-4.jpg' },
    { name: 'Thumbiko James', phone: '345679', avatar: '/path-to-avatar-5.jpg' },
  ],
  isFull: false,
  facilityInfo: {
    beds: 10,
...
const housingReportData = [{
  ...
  description: 'Our five national. Standard carry billion community heavy sit wide thank. Dog energy still see write. Sure likely right senior month project.',
  createdBy: 545,
