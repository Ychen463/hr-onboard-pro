...
export const createFacilityReport = createAsyncThunk(
  ...
  async ({ title, description }, thunkAPI) => {
    try {
      const response = await facilityReportApiService.postCreateFacilityReport({
        title,
        description,
      });
      return response.data;
...
export const addComment = createAsyncThunk(
  ...
  async ({ facilityReportId, description }, thunkAPI) => {
    try {
      const response = await facilityReportApiService.postAddComment({
        facilityReportId,
        description,
      });
      return response.data;
...
export const editComment = createAsyncThunk(
  ...
  async ({ facilityReportId, commentId, description }, thunkAPI) => {
    try {
      const response = await facilityReportApiService.patchEditComment({
        facilityReportId,
        commentId,
        description,
      });
